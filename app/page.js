  ...
  const phases = [
    {
      ...
      description: 'Get started with PostgreSQL basics, installation, and configuration',
      lessons: [
    ...
    },
    {
      ...
      description: 'Comprehensive coverage of all PostgreSQL data types',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn all Data Definition Language commands for creating and modifying database structures',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn about all PostgreSQL constraints including NOT NULL, UNIQUE, PRIMARY KEY, FOREIGN KEY, CHECK, and EXCLUDE',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn about Data Manipulation Language operations including INSERT, UPDATE, DELETE, UPSERT, and COPY',
      lessons: [
    ...
    },
    {
      ...
      description: 'Comprehensive coverage of SELECT queries including WHERE, JOINs, subqueries, CTEs, window functions, and more',
      lessons: [
    ...
    },
    {
      ...
      description: 'Comprehensive coverage of all PostgreSQL functions and operators including string, numeric, date/time, array, JSON, and system functions',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn PostgreSQL procedural language including functions, control structures, cursors, exception handling, dynamic SQL, stored procedures, and triggers',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn about PostgreSQL transactions, isolation levels, locking, MVCC, and concurrent operations',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn PostgreSQL performance optimization including query planning, index optimization, statistics, VACUUM, query techniques, partitioning, and table inheritance',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn PostgreSQL security including roles and privileges, row-level security, column-level security, encryption, and SQL injection prevention',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn PostgreSQL backup and recovery including pg_dump, pg_restore, Point-in-Time Recovery (PITR), and continuous archiving',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn PostgreSQL replication including streaming replication, logical replication, and replication slots',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn about PostgreSQL extensions including popular extensions like PostGIS, pg_trgm, hstore, uuid-ossp, pgcrypto, and how to create custom extensions',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn advanced PostgreSQL features including foreign data wrappers, advanced partitioning, advanced indexing, advanced JSON, advanced full-text search, and advanced aggregation',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn Prisma ORM integration with PostgreSQL including setup, client operations, advanced features, and mapping SQL concepts to Prisma',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn PostgreSQL monitoring and maintenance including system catalogs, performance monitoring, logging, and maintenance tasks',
      lessons: [
    ...
    },
    {
      ...
      description: 'Learn PostgreSQL best practices and patterns including database design, naming conventions, query patterns, and migration strategies',
      lessons: [
    ...
    },
    {
      ...
      description: 'Master database relationships including one-to-one, one-to-many, many-to-many, self-referencing relationships, foreign keys, cascade options, and complete schema design examples',
      lessons: [
    ...
    },
    {
      ...
      description: 'Complete collection of practical queries from simple to advanced complexity, covering SELECT, JOINs, aggregations, subqueries, CTEs, window functions, and complex real-world scenarios with both SQL and Prisma examples',
      lessons: [
      ...
      <main className="max-w-6xl mx-auto px-8 py-16">
        <div className="mb-12">
          <h1 className="text-5xl font-bold mb-4 text-zinc-900 dark:text-zinc-50">
            PostgreSQL Learning Platform
          </h1>
          <p className="text-xl text-zinc-600 dark:text-zinc-400">
            Comprehensive PostgreSQL learning with SQL and Prisma examples
          </p>
        </div>

        <div className="space-y-8">
          {phases.map((phase) => (
            <div key={phase.id} className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {phase.lessons.map((lesson) => (
                  <Link
                    key={lesson.id}
                    href={lesson.path}
                    className="block p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-zinc-800 transition-colors"
                  >
        ...
        <div className="mt-12 bg-blue-50 dark:bg-zinc-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold mb-2 text-zinc-900 dark:text-zinc-50">
            About This Course
          </h3>
          <p className="text-zinc-700 dark:text-zinc-300">
            This comprehensive PostgreSQL course covers everything from basics to advanced topics. 
            Each lesson includes both SQL queries and Prisma ORM examples to help you understand 
            concepts from multiple perspectives. No topic is left behind - we cover every method, 
            function, and concept in PostgreSQL.
          </p>
        </div>
      </main>
    </div>
